        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/clientes/create') }}" class="btn btn-success btn-sm">
                            ...
                            <table class="table">
                                ...
                                @foreach($clientes as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/clientes' .'/'. $item->id) }}"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Ver</button></a>
                                            <a href="{{ url('/clientes'. '/' . $item->id . '/edit') }}"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>
